...
BEGIN_VS_SHADER( LightmappedGeneric, "Help for LightmappedGeneric" )
	...
	void SetupVars( LightmappedGeneric_DX11_Vars_t &info )
	{
	...
	DECLARE_CONSTANT_BUFFER( LightmappedGeneric )

	SHADER_INIT_GLOBAL
	{
		INIT_CONSTANT_BUFFER( LightmappedGeneric );
	}

	SHADER_INIT
	{
		SetupVars( s_info );
		InitLightmappedGeneric_DX11( this, params, s_info );
	}

	SHADER_DRAW
	{
		DrawLightmappedGeneric_DX11( this, params, pShaderAPI, pShaderShadow, s_info, pContextDataPtr, CONSTANT_BUFFER( LightmappedGeneric ) );
	}
END_SHADER