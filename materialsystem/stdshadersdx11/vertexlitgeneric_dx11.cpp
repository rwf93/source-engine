...
BEGIN_VS_SHADER( VertexLitGeneric, "Help for VertexLitGeneric" )
	...
	SHADER_INIT_PARAMS()
	{
		...
		SetupVars( vars );
		InitParamsVertexLitGeneric_DX11( this, params, pMaterialName, true, vars );
	...
	SHADER_INIT
	{
		VertexLitGeneric_DX11_Vars_t vars;
		SetupVars( vars );
		InitVertexLitGeneric_DX11( this, params, true, vars );
	...
	SHADER_DRAW
	{
		...
		if ( bDrawStandardPass )
		{
			VertexLitGeneric_DX11_Vars_t vars;
			SetupVars( vars );
			DrawVertexLitGeneric_DX11( this, params, pShaderAPI, pShaderShadow, true, vars, vertexCompression, pContextDataPtr, CONSTANT_BUFFER( VertexLitGeneric ) );
		}
		else
		{
			// Skip this pass!
